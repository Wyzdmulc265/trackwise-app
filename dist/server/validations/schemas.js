...
export const updateTransactionSchema = z.object({
    ...
    itemId: z.string().optional(),
    quantity: z.number().int().positive().optional(),
}).refine(data => !(data.itemId && !data.quantity) && !(!data.itemId && data.quantity), { message: 'Both itemId and quantity must be provided together, or both omitted' }).refine(data => Object.keys(data).length > 0, {
    message: 'At least one field must be provided',
});
// Approval schemas
